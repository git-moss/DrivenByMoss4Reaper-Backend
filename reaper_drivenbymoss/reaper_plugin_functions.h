...
// Generated by REAPER v5.95pre2/x64
...
// F_FREEMODE_H : float * to free mode height (0..1)P_TRACK : MediaTrack * (read only)
...
// I_CUSTOMCOLOR : int *, custom color, OS dependent color|0x100000 (i.e. ColorToNative(r,g,b)|0x100000). If you do not |0x100000, then it will not be used (though will store the color anyway).
// IP_TAKENUMBER : int, take number within the item (read-only, returns the take number directly)P_TRACK : pointer to MediaTrack (read-only)
